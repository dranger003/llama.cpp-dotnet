...
//            public string grammar = String.Empty;
//            public string cfg_negative_prompt = String.Empty;
//            public float cfg_scale = 1.0f;
//            Dictionary<llama_token, float> logit_bias = new();

//            public llama_sampling_params() { }
//        }
//    }
...
//        // Special tokens
//        [DllImport(LibName)] public static extern llama_token llama_token_bos(llama_model model);
//        [DllImport(LibName)] public static extern llama_token llama_token_eos(llama_model model);
//        [DllImport(LibName)] public static extern llama_token llama_token_nl(llama_model model);

//        // codellama infill tokens
//        [DllImport(LibName)] public static extern llama_token llama_token_prefix(llama_model model);
//        [DllImport(LibName)] public static extern llama_token llama_token_middle(llama_model model);
//        [DllImport(LibName)] public static extern llama_token llama_token_suffix(llama_model model);
//        [DllImport(LibName)] public static extern llama_token llama_token_eot(llama_model model);
...
//        public static Span<llama_token> llama_tokenize(llama_model model, string text, bool add_bos, bool special)
//        {
...
//        [DllImport(LibName)] public static extern llama_grammar llama_grammar_init(nint rules, nuint n_rules, nuint start_rule_index);
...
//        private static extern void _llama_sample_frequency_and_presence_penalties(llama_context ctx, nint candidates, llama_token[] last_tokens, nuint penalty_last_n, float penalty_repeat, float penalty_freq, float penalty_present);
//        public static unsafe void llama_sample_frequency_and_presence_penalties(llama_context ctx, llama_token_data_array candidates, llama_token[] last_tokens, nuint penalty_last_n, float penalty_repeat, float penalty_freq, float penalty_present)
//        {
...
//            _llama_sample_frequency_and_presence_penalties(ctx, new(&_candidates), last_tokens, (nuint)last_tokens.Length, penalty_repeat, penalty_freq, penalty_present);
//        }
